...
{
    private string iosGameID = "1494452";
    private string androidGameID = "1494451";
    ...
    public static void ShowAd(string zoneID, Action handleFinished)
    {
        ...
        {
//            ConfirmDlg.CreateOnlyConfirm(LanguageManager.GetInstance().GetText("ad_supported"));
            return;
        }
        if (!UnityAdsHelper.isInitialized)
        {
//            ConfirmDlg.CreateOnlyConfirm(LanguageManager.GetInstance().GetText("ad_is_init_fail"));
            return;
        }
        if (UnityAdsHelper.isShowing)
        {
//            ConfirmDlg.CreateOnlyConfirm(LanguageManager.GetInstance().GetText("ad_is_initialized"));
            return;
        }
#endif
    ...
    public static void ShowAd(string zoneID, Action handleFinished, Action handleSkipped, Action handleFailed, Action onContinue)
    {
        ...
        {
//            ConfirmDlg.CreateOnlyConfirm(LanguageManager.GetInstance().GetText("Unable_to_show_ad"));
