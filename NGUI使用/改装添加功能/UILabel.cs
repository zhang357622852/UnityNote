...
public class UILabel : UIWidget
{
    ...
    #region 自定义方法
    [ContextMenu("按钮Label效果1")]
    private void CustomEffect1()
    {
        color = Color.white;

        effectStyle = Effect.Outline8;
        effectColor = BJUtility.HexToColor("75570F");
        effectDistance = new Vector2(1.3f, 1.3f);
    }

    [ContextMenu("按钮Label效果2")]
    private void CustomEffect2()
    {
        color = BJUtility.HexToColor("C8DEC6");

        effectStyle = Effect.Outline8;
        effectColor = BJUtility.HexToColor("293B4F");
        effectDistance = new Vector2(1.3f, 1.3f);
    }

    [ContextMenu("白字黑描边")]
    private void CustomEffect3()
    {
        color = Color.white;
    ...
    private void ClearEffect()
    {
        ...
        effectStyle = Effect.None;
        effectColor = Color.black;
        effectDistance = new Vector2(1f, 1f);

        applyGradient = false;

        //Overflow我还是喜欢默认是 Resize Freely
        mOverflow = Overflow.ResizeFreely;
    }
    #endregion
}
